...
| 작업 | 경로 | 역할 |
|------|------|------|
| 생성 | `src/content/posts/xdd-ch02-same-requirements-different-code.md` | Ch.2 블로그 포스트 본문 |
...
**파일:**
- 생성: `src/content/posts/xdd-ch02-same-requirements-different-code.md`
...
```bash
git add src/content/posts/xdd-ch02-same-requirements-different-code.md
...
**파일:**
- 수정: `src/content/posts/xdd-ch02-same-requirements-different-code.md`
