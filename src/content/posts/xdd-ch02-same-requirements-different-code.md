...
- 개발 시 Spec을 정리하고, 이 Spec에 따라 개발하는 것이 **AI 시대에 왜 유리**할까?
- **DDD의 Building Blocks가 SDD와 왜 잘 맞을까?**

다음 글(Ch.3)에서 이 질문들에 답합니다. `Name`, `Email`, `RewardPoints` 같은 Value Object의 Spec을 직접 정의하고, 그 Spec으로 설계하는 **SDD 사이클을 실전으로 시연**합니다.
